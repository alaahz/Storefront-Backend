...
var UserHandler = /** @class */ (function () {
    ...
    UserHandler.prototype.SignUp = function (_req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userInfo, newUser, token, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, user.createUser(userInfo)];
                    case 2:
                        newUser = _a.sent();
    ...
    UserHandler.prototype.SignIn = function (_req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, existingUser, token, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (!existingUser) {
                            return [2 /*return*/, res.status(404).send('The passowrd or email is incorrect.')];
                        }
                        token = jsonwebtoken_1.default.sign({ u: existingUser }, UserHandler.tokenSecret);
                        return [2 /*return*/, res.status(200).json({ token: token })];
                    case 3:
                        err_2 = _a.sent();
                        return [2 /*return*/, res.status(400).json("Could not sign in, ".concat(err_2))];
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserHandler.prototype.getAllUsers = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var allUsers, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user.allUsers()];
                    case 1:
                        allUsers = _a.sent();
                        return [2 /*return*/, res.status(200).json({ userList: allUsers })];
                    case 2:
                        err_3 = _a.sent();
    ...
    UserHandler.prototype.getOneUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, userInfo, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, user.findUserById(userId)];
                    case 2:
                        userInfo = _a.sent();
    ...
    UserHandler.prototype.UpdateUser = function (_req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var column, value, userId, upDated, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, user.update(column, value, userId)];
                    case 2:
                        upDated = _a.sent();
    ...
    UserHandler.prototype.deleteUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, uDelete, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userId = parseInt(req.params.userId);
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, user.deleteUser(userId)];
                    case 2:
                        uDelete = _a.sent();
                        return [2 /*return*/, res.status(200).json({ message: 'User successfuly deleted' })];
                    case 3:
                        err_6 = _a.sent();
    ...
    UserHandler.tokenSecret = process.env.TOKEN_SECRET;
    return UserHandler;
}());
